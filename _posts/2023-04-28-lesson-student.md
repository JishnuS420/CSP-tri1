...
nb_path: _notebooks/2023-04-28-lesson student.ipynb
layout: notebook
---
...
#################################################
# file to edit: _notebooks/2023-04-28-lesson student.ipynb
-->
...
<span class="k">def</span> <span class="nf">init_leaderboards</span><span class="p">():</span>
    <span class="k">with</span> <span class="n">app</span><span class="o">.</span><span class="n">app_context</span><span class="p">():</span>
        ...
        <span class="n">l3</span> <span class="o">=</span> <span class="n">Leaderboard</span><span class="p">(</span><span class="n">username</span><span class="o">=</span><span class="s2">&quot;boba&quot;</span><span class="p">,</span> <span class="n">password</span><span class="o">=</span><span class="s2">&quot;applee&quot;</span><span class="p">,</span> <span class="n">pointsEasy</span><span class="o">=</span><span class="mi">150</span><span class="p">,</span> <span class="n">pointsMedium</span><span class="o">=</span><span class="mi">250</span><span class="p">,</span> <span class="n">pointsHard</span><span class="o">=</span><span class="mi">350</span><span class="p">)</span>
...
<li>add a new leaderboard, and edit the bobbert leaderboard; add proof with a screenshot of the sqlite.db
<img src="https://raw.githubusercontent.com/JishnuS420/CSP-tri1/master/images/dbhacks1.png" alt="image"></li>
<li>add a new set of keys and values to the leaderboard; add proof with a screenshot of the sqlite.db
<img src="https://raw.githubusercontent.com/JishnuS420/CSP-tri1/master/images/dbhack2.png" alt="image"></li>
</ul>
...
<ul>
<li>Some methods that we can use to store and access images in the backend includes:database storage, cloud storage and file system storage. we can send them to a frontend application by using data urls, urls, and base64 encoding. </li>
</ul>
...
<li>These endpoints are based on requests that can be made to change the database.</li>
...
<li><code>Blueprint</code>: used to organize the routes and functions</li>
...
<li>Since this is a text database, to pull specific information from the database, the API will search through the data using the username, which is unique.</li>
...
<p>The 4 methods are GET, POST, PUT, DELETE</p>
<ol>
<li>What is a parser and how would it be aid with data validation?</li>
</ol>
<p>Parser is a tool that allows you to extract structured data from unstructured or semi-structured input data for example, json. It would aid with data validation since you can prevent malformed data from causing something to break in your application</p>
<ol>
<li>What is the role endpoints in Flask?</li>
</ol>
<p>In Flask, an endpoint is a function that maps to a specific URL route. When a user makes an HTTP request to a particular URL, Flask will route the request to the appropriate endpoint function based on the URL pattern.</p>
...
<p>Images are stored in a Flask API by storing images as files on a server or storing image data in a database as binary data or URLs or using cloud storage services. When requested, its displayed typically using Base64</p>
<ol>
<li>What is the <code>fetch()</code> function and how is it used in frontend logic?</li>
</ol>
<p>fetch() allows you to make HTTP requests to a server from a frontend application and is used in frontend logic to retrieve data from a server API.</p>
<ol>
<li>How is data formatted and sent to the backend? (mention JSON in your answer)</li>
</ol>
<p>When sending data to the backend in a Flask API, JSON is used to format for data serialization. JSON is easily parsed and generated by both backend and frontend applications</p>
...
<ul>
<li>It's a sorting algorithm that uses a divide-and-conquer strategy to sort an array of elements. You select a "pivot" element from the array and partitioning the other elements into two sub-arrays, according to whether they are less than or greater than the pivot. The time complexity of Quicksort is O(n log n). </li>
</ul>
...
<div class="cell border-box-sizing text_cell rendered"><div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<h2 id="Hacks---Frontend-and-Backend">Hacks - Frontend and Backend<a class="anchor-link" href="#Hacks---Frontend-and-Backend"> </a></h2><p>Attempted to do Frontend and Backend (spent 7+ hours but couldn't figure it out so we gave up)</p>
<p>Frontend:</p>
<p><a href="https://github.com/A1234l/Group-frontend">https://github.com/A1234l/Group-frontend</a></p>
<p>Backend:</p>
<p><a href="https://github.com/A1234l/Group-backend">https://github.com/A1234l/Group-backend</a></p>
...
<h2 id="HACKS-ARE-DUE-SATURDAY-(4/29)-11:59-PM">HACKS ARE DUE SATURDAY (4/29) 11:59 PM<a class="anchor-link" href="#HACKS-ARE-DUE-SATURDAY-(4/29)-11:59-PM"> </a></h2><p><strong>got extension</strong></p>
...
<div class="cell border-box-sizing text_cell rendered"><div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<h2 id="Hacks---Quicksort-Hacks">Hacks - Quicksort Hacks<a class="anchor-link" href="#Hacks---Quicksort-Hacks"> </a></h2><p>Quicksort Diagram
<a href="https://cdn.discordapp.com/attachments/1083120046269804595/1102855297715941386/Quicksort.jpg">https://cdn.discordapp.com/attachments/1083120046269804595/1102855297715941386/Quicksort.jpg</a></p>
