...
<ul>
<li>Example 1:What is the minimum amount of time (approximate) to execute all three processes when two processes run in parallel?50 seconds, as the longest process runs, the shorter ones end up finishing </li>
<li>Example 2: What is the difference ine execution time between running the two processes in parallel in place of running them one after the other on a single processor?
When running it on one processor, you need to wait for one process to finish before the next one can go, the answer was: Parallel - one after the other = (25 + 45) - 45 = 25 seconds
Data Structures.  Build a List Comprehension example</li>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython3"><pre><span></span><span class="n">fruits</span> <span class="o">=</span> <span class="p">[</span><span class="s2">&quot;Apple&quot;</span><span class="p">,</span> <span class="s2">&quot;Banana&quot;</span><span class="p">,</span> <span class="s2">&quot;Cherry&quot;</span><span class="p">,</span> <span class="s2">&quot;Dragonfruit&quot;</span><span class="p">,</span> <span class="s2">&quot;Elderberry&quot;</span><span class="p">,</span> <span class="s2">&quot;Fig&quot;</span><span class="p">,</span> <span class="s2">&quot;Grape&quot;</span><span class="p">,</span> <span class="s2">&quot;Honeydew&quot;</span><span class="p">]</span>

<span class="n">newlist</span> <span class="o">=</span> <span class="p">[</span><span class="n">x</span> <span class="k">for</span> <span class="n">x</span> <span class="ow">in</span> <span class="n">fruits</span> <span class="k">if</span> <span class="s2">&quot;e&quot;</span> <span class="ow">in</span> <span class="n">x</span><span class="p">]</span>
...
<pre>[&#39;Apple&#39;, &#39;Cherry&#39;, &#39;Elderberry&#39;, &#39;Grape&#39;, &#39;Honeydew&#39;]
</pre>
</div>
</div>
